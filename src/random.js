...
exports.captchaNumber = function(length) {
    let orgLength = '10000000000000000000000000'
    let upLen = parseInt(length, 10) || 4
    let finLen = orgLength.substring(0, upLen + 1);
    let randomNo = Math.floor((Math.random() * finLen) + 1);
